<template>
  <v-app-bar elevation="0" height="56" class="mart-appbar px-3">
    ...
    <v-divider vertical class="mx-2 border-opacity-20" style="height:24px;align-self:center" />
    ...
    <v-responsive max-width="400" min-width="120" class="flex-grow-1 mx-3">
      ...
      >
        <template #prepend-inner>
          <v-icon icon="mdi-magnify" color="grey-darken-1" size="16" class="mr-1" />
        </template>
    ...
    <div class="right-block">
      ...
      >
        <v-icon :icon="isFullscreen ? 'mdi-fullscreen-exit' : 'mdi-fullscreen'" size="20" />
      </v-btn>
